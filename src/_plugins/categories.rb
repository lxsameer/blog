  ...
  class CategoryListTag < Liquid::Tag
    def render(context)
      ...
      categories.sort.each do |category|
        ...
        html << "<div class='item'><a href='/categories/#{category}/'><div class='ui mini #{colors.sample} image label'>#{category.capitalize}<div class='detail'>#{posts_in_category}</div></div></a></div>\n"
      end
      html
    end
  end
